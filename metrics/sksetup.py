...
def main():
    ...
    for dataset in pbar:
        ...
        df = pd.read_csv('./output/' + dataset + "_metrics.csv")
        ...
        recall_df.to_csv("./sk_data/" + dataset + "_recall+_.csv", header = None, index=True, sep=' ')
        
        prec_df = pd.DataFrame.from_dict(precisiondict, orient = 'index')
        prec_df.to_csv("./sk_data/" + dataset + "_prec+_.csv", header = None, index=True, sep=' ')

        acc_df = pd.DataFrame.from_dict(accdict, orient = 'index')
        acc_df.to_csv("./sk_data/" + dataset + "_acc+_.csv", header = None, index=True, sep=' ')

        F1_df = pd.DataFrame.from_dict(F1dict, orient = 'index')
        F1_df.to_csv("./sk_data/" + dataset + "_F1+_.csv", header = None, index=True, sep=' ')

        FA0_df = pd.DataFrame.from_dict(FA0dict, orient = 'index')
        FA0_df.to_csv("./sk_data/" + dataset + "_FA0-_.csv", header = None, index=True, sep=' ')

        FA1_df = pd.DataFrame.from_dict(FA1dict, orient = 'index')
        FA1_df.to_csv("./sk_data/" + dataset + "_FA1-_.csv", header = None, index=True, sep=' ')

        MSE_df = pd.DataFrame.from_dict(MSEdict, orient = 'index')
        MSE_df.to_csv("./sk_data/" + dataset + "_MSE-_.csv", header = None, index=True, sep=' ')

        MCC_df = pd.DataFrame.from_dict(MCCdict, orient = 'index')
        MCC_df.to_csv("./sk_data/" + dataset + "_MCC-_.csv", header = None, index=True, sep=' ')

        AOD_df = pd.DataFrame.from_dict(AODdict, orient = 'index')
        AOD_df.to_csv("./sk_data/" + dataset + "_AOD-_.csv", header = None, index=True, sep=' ')

        EOD_df = pd.DataFrame.from_dict(EODdict, orient = 'index')
        EOD_df.to_csv("./sk_data/" + dataset + "_EOD-_.csv", header = None, index=True, sep=' ')

        SPD_df = pd.DataFrame.from_dict(SPDdict, orient = 'index')
        SPD_df.to_csv("./sk_data/" + dataset + "_SPD-_.csv", header = None, index=True, sep=' ')

        DI_df = pd.DataFrame.from_dict(DIdict, orient = 'index')
        DI_df.to_csv("./sk_data/" + dataset + "_DI-_.csv", header = None, index=True, sep=' ')

        FLIP_df = pd.DataFrame.from_dict(FLIPdict, orient = 'index')
        FLIP_df.to_csv("./sk_data/" + dataset + "_Flip_.csv", header = None, index=True, sep=' ')
